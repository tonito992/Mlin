    ...
    public class UILineRenderer : Graphic
    {
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            for (int i = 0; i < this.points.Length-1; i++)
            {
                ...
                this.CreateLineSegment(this.points[i], this.points[i+1], vh);
        ...
        {
            Vector3 offset = this.center ? (rectTransform.sizeDelta / 2) : Vector2.zero;
            ...
            Quaternion point1Rotation = Quaternion.Euler(0, 0, this.RotatePointTowards(point1, point2) + 90);
            vertex.position = point1Rotation * new Vector3(-this.thickness / 2, 0);
            ...
            Quaternion point2Rotation = Quaternion.Euler(0, 0, this.RotatePointTowards(point2, point1) - 90);
            vertex.position = point2Rotation * new Vector3(-this.thickness / 2, 0);
